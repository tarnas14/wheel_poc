...
export class Wheel2 extends React.Component<Wheel2.Props, Wheel2.State> {
  container: any = {};
  stageRef: any = {};
  arcRefs = {};
            ...
            <Layer>
              {this.props.wheel.map(arc => <Motion
                ...
                style={{
                  ...
                  innerRadius: arc.radius.inner,
                  outerRadius: this.state.mounted ? spring(arc.radius.outer) : arc.radius.inner
                }}
              >
